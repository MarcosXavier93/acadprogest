# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2018-04-01 02:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('d_requisito', models.ManyToManyField(blank=True, to='coredrca.Disciplina')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=30)),
                ('departamento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='coredrca.Departamento')),
            ],
        ),
        migrations.CreateModel(
            name='Secretaria',
        ...
        migrations.AddField(
            ...
            name='professor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='coredrca.Professor'),
        ),
        migrations.AddField(
            model_name='curso',
            name='secretaria',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='coredrca.Secretaria'),
        ),
        migrations.AddField(
            model_name='aluno',
            name='credito',
